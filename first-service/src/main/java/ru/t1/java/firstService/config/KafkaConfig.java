package ru.t1.java.firstService.config;
...
import ru.t1.java.firstService.kafka.KafkaClientProducer;
import ru.t1.java.firstService.kafka.KafkaDataSourceExceptionProducer;
import ru.t1.java.firstService.kafka.KafkaMetricProducer;
